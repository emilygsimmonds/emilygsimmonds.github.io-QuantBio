---
subtitle: "ST2304 Statistical modelling for Biologists and Biotechnologists V2020"
...
<span style="color:blue"> **PAUSE HERE**. </span>
...
The list below shows some basic tools for plotting using both`plot()`and `qplot()` (from the `ggplot2` package).
...
<span style="color:blue"> Now see if you can write another, this time to add 5 to any value. </span> 
...
# Part G: Importing and exporting  
...
```
For plotting there is actually another way you can plot columns within a data frame. **You will need to be familiar with this technique for later classes!** The second way is to use the argument `data`. With this argument you can specify where R should look for the column you put in the x and y position. 

<span style="color:blue"> Run the line below. You should get the same plot as before, but you don't!
Can you work out why not? </span>
